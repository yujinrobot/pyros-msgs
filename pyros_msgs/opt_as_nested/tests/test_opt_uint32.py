...
pyros_msgs.opt_as_nested.duck_punch(test_gen_msgs.test_opt_uint32_as_nested, ['data'])
...
def test_init_rosdata(data):
    ...
    msg = test_gen_msgs.test_opt_uint32_as_nested(data=data)
...
def test_init_raw(data):
    ...
    msg = test_gen_msgs.test_opt_uint32_as_nested(data)
    assert msg.data == data


def test_init_default():
    """Testing default value"""
    msg = test_gen_msgs.test_opt_uint32_as_nested()
...
def test_wrong_init_except(data):
    ...
    with pytest.raises(AttributeError) as cm:
        test_gen_msgs.test_opt_uint32_as_nested(data)

...
generated_modules = generate_msgsrv_nspkg(
    [os.path.join(os.path.dirname(__file__), 'msg', 'test_opt_int8_as_nested.msg')],
...
pyros_msgs.opt_as_nested.duck_punch(test_opt_int8_as_nested, ['data'])
...
def test_init_rosdata(data):
    ...
    msg = test_opt_int8_as_nested(data=data)
...
def test_init_raw(data):
    ...
    msg = test_opt_int8_as_nested(data)
    assert msg.data == data


def test_init_default():
    """Testing default value"""
    msg = test_opt_int8_as_nested()

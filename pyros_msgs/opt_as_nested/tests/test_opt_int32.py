...
generated_modules = generate_msgsrv_nspkg(
    [os.path.join(os.path.dirname(__file__), 'msg', 'test_opt_int32_as_nested.msg')],
...
import_msgsrv('gen_msgs.msg._test_opt_int32_as_nested')

test_opt_int32_as_nested = getattr(sys.modules['gen_msgs.msg._test_opt_int32_as_nested'], 'test_opt_int32_as_nested')


import pyros_msgs.opt_as_nested
# patching (need to know the field name)
pyros_msgs.opt_as_nested.duck_punch(test_opt_int32_as_nested, ['data'])
...
def test_init_rosdata(data):
    ...
    msg = test_opt_int32_as_nested(data=data)
...
def test_init_raw(data):
    ...
    msg = test_opt_int32_as_nested(data)
    assert msg.data == data


def test_init_default():
    """Testing default value"""
    msg = test_opt_int32_as_nested()

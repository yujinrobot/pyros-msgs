...
try:
    ...
    from pyros_msgs.msg import test_opt_std_empty_as_array  # a message type just for testing
except ImportError:
...
def test_init_rosdata():
    msg = test_opt_std_empty_as_array(data=[std_msgs.Empty()])
...
def test_init_raw():
    msg = test_opt_std_empty_as_array(std_msgs.Empty())
    assert msg.data == [std_msgs.Empty()]
